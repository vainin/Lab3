...
namespace Lab3
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        void SortClue(System.Object sender, System.EventArgs e)
        {
            EntriesLV.ItemsSource = MauiProgram.ibl.SortByClueEntries();
        }

        void SortAnswer(System.Object sender, System.EventArgs e)
        {
            EntriesLV.ItemsSource = MauiProgram.ibl.SortByAnswerEntries();
        }
